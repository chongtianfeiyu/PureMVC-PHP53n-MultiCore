...
use org\puremvc\php53n\multicore\core\Controller;
use org\puremvc\php53n\multicore\core\Model;
use org\puremvc\php53n\multicore\core\View;
use org\puremvc\php53n\multicore\interfaces\IFacade;
...
use org\puremvc\php53n\multicore\patterns\observer\Notification;

require_once 'org/puremvc/php53n/multicore/core/Controller.php';
require_once 'org/puremvc/php53n/multicore/core/Model.php';
require_once 'org/puremvc/php53n/multicore/core/View.php';
require_once 'org/puremvc/php53n/multicore/interfaces/IFacade.php';
...
require_once 'org/puremvc/php53n/multicore/patterns/observer/Notification.php';
...
class Facade implements IFacade
{
    ...
    public static function getInstance( $key )
    {
        if (!isset( self::$instanceMap[ $key ] ) )
        {
            self::$instanceMap[ $key ] = new self( $key );
        }
     ...
     * @param string $commandClassRef <b>ICommand</b> object to register.
     * @return void
     */
